...
from saysomething.commands import forge, initdb


class SaySomethingTestCase(unittest.TestCase):
    ...
    def test_index_page(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('Say Something', data)
    ...
    def test_create_message(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('You have said something.', data)
